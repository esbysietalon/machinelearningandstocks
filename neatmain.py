...
class Main(object):
    ...
    def speciate(self):
        ...
        # for sx in range(0, len(self.__species)):
            # print("SPECIES POP IS: " + str(len(self.__species[sx])))
    ...
    def evolve(self):
        ...
        for sx in range(0, len(self.__species)):
            ...
            print("SPECIES FITNESS IS: " + str(speciesfitness[sx]))
            if len(self.__species[sx]) > 0:
